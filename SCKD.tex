...
\tlhw{baj}\tlhd{verb}{(Actively) work for.}[Garner.][Earn.]
\tlhrf{Though any perceived attack on one's honor may prompt one to issue a challenge, in one traditional form of duel, the goal is specifically for a man to "win the favor of a women" ({vuv be' 'e' baj} [literally, "earn that a woman respect him"]) by competing with another man.}{KGT}{69}
\textit{Canon: }\tlhc{yInlu'taH 'e' bajnISlu'}{Survival must be earned.}{TKW}
\tlhc{yay chavlu' 'e' bajnISlu'}{Victory must be earned.}{TKW}
\tlhf{TKW}[KGT]
